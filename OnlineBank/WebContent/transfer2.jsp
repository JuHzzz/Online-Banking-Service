...
<%
	...
	session.setAttribute("token6", tokenValue);
%>

	<div>
		<h1 align="left" style="color: red">输入密码</h1>
		<HR style="FILTER: alpha(opacity = 100, finishopacity = 0, style = 3)"
			width="100%" color=#987cb9 SIZE=3>
	</div>

	<div class="box">
		<form action="transfer2" class="form" id="formER" method = "post">

			<p style="color: gray;">请输入您的密码</p>
